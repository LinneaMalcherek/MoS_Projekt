// kanske skicka in spelare in i drawscene
// isåfall ska denna gå igenom dess stones, se hur många som finns och rita ut med olika färg typ.. men bara stenarna!!
 ...
 function drawScene(players) {
        ...
        for (var j=0; j<players.length; j++) {
            ...
            if (allStones[i].render){
                ...
                mat4.translate(mMatrix, [-0.15,-12,-0.2]);
